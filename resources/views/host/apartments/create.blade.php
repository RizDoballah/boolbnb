              ...
              <form method='POST' action="{{route('host.store')}}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                      ...
                      <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                          name='title' placeholder="inserisci un titolo" value="{{old('title')}}">
                      @error('title')
                  ...
                  <div class="form-group">
                      ...
                      <input autocomplete="off" class='counter' name='rooms' type="number" min="1" value="{{(empty(old('rooms'))) ? '0' : old('rooms')}}" />
                  ...
                  <div class="form-group">
                      ...
                      <span class='down_count btn' title='Down'><i class="fas fa-minus"></i></span>
                      <input autocomplete="off" class='counter' name="beds" type="number" min="1" value="{{(empty(old('beds'))) ? '0' : old('beds')}}" />
                      <span class='up_count btn' title='Up'><i class="fas fa-plus"></i></span>
                      @error('beds')
                        <small class="form-text text-danger">{{$message}}</small>
                      @enderror
                  ...
                  <div class="form-group">
                      ...
                      <span class='down_count btn' title='Down'><i class="fas fa-minus"></i></span>
                      <input autocomplete="off" class='counter' name="bathroom" type="number" min="1" value="{{(empty(old('bathroom'))) ? '0' : old('bathroom')}}" />
                      <span class='up_count btn' title='Up'><i class="fas fa-plus"></i></span>
                      @error('bathroom')
                        <small class="form-text text-danger">{{$message}}</small>
                      @enderror
